...
using SWE.Infrastructure.Messaging.Interfaces;
using SWE.Infrastructure.Abstractions.Interfaces.Contracts;

namespace SWE.Infrastructure.Messaging.Handlers
{
    /// <summary>
        ...
        : IMessageHandler<T>
    {
        ...
        public MessageHandler(IHandler<T> handler, ILogger<MessageHandler<T>> logger)
        {
            Handler = handler;
            Logger = logger;
        }
