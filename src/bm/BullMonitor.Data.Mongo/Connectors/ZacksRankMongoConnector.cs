        ...
        , IBaseMongoConnector<ZacksRankEntity>
    {
            ...
            ZacksRankEntity value)
        {
            ...
            throw new NotImplementedException(
                $"{nameof(ZacksRankMongoConnector)}_{nameof(GenerateUpdateFilter)}");
        }
    }
}